...
> **状态:** v0.1.3 已发布。工具箱提供结构化日志、用户配置、缓存、Homebrew 后端、包搜索、安装建议、全量离线命令索引、智能 command-not-found、稳定/开发安装通道和自动更新。后续计划见 `.ai/ROADMAP.md`(Doctor、Plugin、更多后端)。
